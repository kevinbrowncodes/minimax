<!-- MiniMax's Video Prompt Writing Guide (base modes: T2VA / I2VA / FL2VA / L2VA), copied verbatim from the MiniMax-H3 release so this skill is self-contained; the repo's copy is docs/references/prompt-guides/. Saved 2026-09-13; copied here 2026-09-16. -->
