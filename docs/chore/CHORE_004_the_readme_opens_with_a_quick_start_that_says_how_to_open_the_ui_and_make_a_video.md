...
- [x] `README.md`: new **Quick Start** section after the intro — the UI's LAN URL, making a video, extending one, the model's run/stop/verify commands, measured times and memory, a troubleshooting table, and where the deeper sections are.
