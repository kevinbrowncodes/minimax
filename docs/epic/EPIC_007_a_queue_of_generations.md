...
**Status:** Done (2026-09-15 17:38 EDT — STORY_043's chain finished on the Spark; the docs landed after) — opened 2026-09-15 as EPIC_006 closed, the owner: "I want schedules at least my implementation to occur so I can submit multiple jobs one after another"; on the drafted first story: "Approve, but add timed runs"
**Started:** 2026-09-15
...
| **Actual completion** | **2026-09-15 14:29 EDT** (the second generation of the manual verification finished; the docs landed minutes after) — against the second session's ≈ 15:40 estimate, ≈ 70 min early: stage two took 13:27–13:52 (the estimate said ≈ 60 min), the e2e ≈ 10 min, the two real generations 13:52–14:29 (as estimated). The first session stopped at 13:06 at the owner's request with stage one done. **STORY_042** (picked and drafted 14:40, approved 14:44) landed at **15:28 EDT** against ≈ 15:20. **The epic closed at 17:38 EDT** (STORY_043's real chain done; CHORE_011 and BUG_007 on the way) against the closing path's ≈ 19:20 estimate — ≈ 1 h 40 min early, the story's build taking 16:41–17:05 (the estimate said ≈ 90 min) and the chain 38 min 52 s (≈ 45 min estimated). First story to last: 12:57 → 17:38, 4 h 41 min, five tickets |
...
| 044 → **043** | [A queued extension waits for its source](../story/STORY_043_a_queued_extension_waits_for_its_source.md) — the redefined candidate (owner, 2026-09-15 15:45 EDT: "Approve the path"): the chain from the page rather than a script file — an extension queued against a running or waiting clip is not due until its source is done, then goes with the source's real job id; Queue an extension on the rows; Extend on a pending task page. A script-file import stays a later candidate if still wanted | **Done (2026-09-15)** | ≈ 90 min + ≈ 45 min verification | 2026-09-15 16:41 EDT | ≈ 19:10 EDT if approved by ≈ 16:50 (the epic's close ≈ 19:20; the BUG_007 fix and the push queue moved it from ≈ 18:30) | **2026-09-15 17:38 EDT** (built and deployed by 17:05 — 24 min against ≈ 90; the chain 16:59–17:38) |
...
## Remaining work (2026-09-15 16:40 EDT)

1. ~~Withdraw 043~~ — done. 2. ~~CHORE_011~~ — landed (`286795d`), deployed. (Found on the way: **BUG_007**, an extension of a queued job refused by the adapter — fixed, `221b497`, deployed.) 3. ~~**STORY_043**~~ — landed (`c83d187`), deployed, the real chain verified 17:38 EDT. 4. ~~Close the epic~~ — **closed 2026-09-15 17:38 EDT** (the estimate said ≈ 19:20). What the owner asked for next — one starting frame and any number of scripts in a single Send, and the 30 s source cap that stands in the way of a 60 s chain — is [EPIC_008](EPIC_008_a_whole_video_from_one_send.md), drafted the same evening for his approval; nothing of it is in this epic.
