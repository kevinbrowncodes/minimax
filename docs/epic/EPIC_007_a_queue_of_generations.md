...
1. ~~Withdraw 043~~ — done. 2. ~~CHORE_011~~ — landed (`286795d`), deployed. (Found on the way: **BUG_007**, an extension of a queued job refused by the adapter — fixed, `221b497`, deployed.) 3. **STORY_043** (a queued extension waits for its source) — approved, being built. 4. Close the epic. Estimated close ≈ 19:20 EDT. One item at a time.
