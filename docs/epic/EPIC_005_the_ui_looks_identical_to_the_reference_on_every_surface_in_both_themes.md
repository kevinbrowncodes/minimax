...
| 022+ | The remaining rebuild stories, cut from 018's "What we lack": the home and composer (attach menu and submenus, More chip menu, the Showcase row and the other modes' Showcases, the tag placement), the task page (thread rows, result file card and preview pane, Work Area panel with Deliverables, credits notice), Assets (From you / Star tabs, chip empty states, the tile ⋯ menu), and the pages behind the sidebar (Plugins and Manage, Scheduled, Connect mobile, MaxHermes, MaxClaw) rendered as the reference renders them and inert. **Numbered from 021: STORY_020 was taken by EPIC_004's extension work on 2026-09-14** | To draft after 021 |
