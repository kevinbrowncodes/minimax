...
| # | Story | Status |
| --- | --- | --- |
| 001 | [The owner signs in to the reference once and every recon run reuses that session](../story/STORY_001_the_owner_signs_in_to_the_reference_once_and_every_recon_run_reuses_that_session.md) | In progress |
| 002 | [Every state of the video generation flow is captured as dated screenshots](../story/STORY_002_every_state_of_the_video_generation_flow_is_captured_as_dated_screenshots.md) | Draft |
