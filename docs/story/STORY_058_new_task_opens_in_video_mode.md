...
**Addendum — verified on the deployed app (2026-09-18 15:05 EDT; `app/e2e-trial/home.spec.ts`, the screenshots `spark/data/smoke/home-light-1440-*`, `home-dark-1440-*`, `home-narrow-390-2026-09-18T19-04-52-070Z.png`):** New task opens on the heading *MiniMax*, the *+ Reference* tile, the placeholder *Describe the video — or attach a photo and turn Agent on*, the bar with *+*, *Agent*, *MiniMax-H3*, *16:9 · 768P · 5s*, *Run at…* and Send — no chips row, no Showcase, no card in the corner; the same in dark and at 390. Beside `home-signed-in@1440`: the heading in the reference's place (y 231) and type, the card at y 302; the reference's slogan, chips, Showcase and carousel are the Departures. (The *video-creator* tag and the *MiniMax-M3* pill, still in this story's after-picture, went in STORY_059 the same hour.)
