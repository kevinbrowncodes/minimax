...
| The pages behind the sidebar — Plugins (the reference's Management page: Plugins / Skills / Apps / Agents tabs and the agent editor) and Connect mobile — rendered as the reference renders them, every control inert (the notice on click), kept for the wiring epic ([EPIC_006](docs/epic/EPIC_006_what_minimax_local_kept_from_the_reference_works_for_the_video_workflow.md)); MaxHermes / MaxClaw and the More section went with STORY_028 | STORY_025, STORY_026, STORY_028 |
