...
| The pages behind the sidebar — Plugins (Market / Personal, categories, search, plugin and skill cards) and Plugins › Manage (Management, the Agents tab and its editor), Schedules, Connect mobile, MaxHermes and MaxClaw — rendered as the reference renders them, every control inert (the notice on click); the rows, the rail, More › MaxHermes / MaxClaw and the Agents guide's View now lead to them | STORY_025 |
