...
| The pages behind the sidebar — Plugins (the reference's Management page: Plugins / Skills / Apps / Agents tabs and the agent editor), Connect mobile, MaxHermes and MaxClaw — rendered as the reference renders them, every control inert (the notice on click), kept for the wiring epic ([BACKLOG_007](docs/backlog/BACKLOG_007_the_kept_reference_surfaces_are_wired_for_the_video_workflow.md)) | STORY_025, STORY_026 |
