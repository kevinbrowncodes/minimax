/**
 * A small multipart/form-data parser for the stub's POST /jobs (STORY_008): text fields plus a few files, with limits.
 * Not a general parser — it handles what browsers and fetch's FormData send.
 */
